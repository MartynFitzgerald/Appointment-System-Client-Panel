...
class Customers extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedItems: this.props.action !== 'Add' ?  this.props.selectedItems : [{ "first_name": "", "last_name": "", "email_address": "", "phone_number": "" }],
      selection: 0
    };
  }
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              ...
              <TextField
                ...
                margin="dense"
                id="emailAddress"
                label="E.g. martyn.fitzgerald@appointmentsystem.com"
                type="text"
    ...
    if (action === 'Modify') {
      if (selectedItems.length > 1) {
        ...
        <Grid container direction="row" justify="center" alignItems="center" >
          <Grid item xs={6} sm={6}>
            <DialogTitle id="form-dialog-title" aria-labelledby="form-dialog-title">{action} Customer</DialogTitle>
          </Grid>
          <Grid item xs={6} sm={6} style={{textAlign: "center"}}>
            <FormControl variant="outlined" size="small" className={classes.formControl}>
              <InputLabel id="branch-dropdown-label">Customer</InputLabel>
                <Select
